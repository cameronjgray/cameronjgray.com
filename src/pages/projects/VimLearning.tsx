...
export function VimLearning() {
  ...
  return (
    <div className="pb-3">
      ...
      <div className="py-5">
        <p>Over the years I'd come in contact with Vim a couple times and always been too intimidated to give it a shot. Then I came across <a href="https://vim-adventures.com/">Vim Adventures</a> which gets you used to Vim motions through a fun puzzle game. Each level introduces new concepts and the only way to complete the game is to take them on board.</p>

        <p className="pt-3">After playing through the game a couple times I started to use Vim on occasion to do small tasks. I also installed a Vim extension into VS Code to help me practice the motions. I eventually came across NeoVim and after watching some guides on YouTube I started to build my own setup. You can see the current version on <a href="https://github.com/cameronjgray/nvim">Github</a>.</p>
